---
title: "KEGG Module and Pathways testdata"
output:
  html_document:
    df_print: paged
---
...
base_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/TESTDATA"

# Input Files
kegg_modules_file <- file.path(base_dir, "01_function_testdata.tsv")
relative_abundance_file <- file.path(base_dir, "03_relativeabundance.tsv")
...
output_file <- file.path(base_dir, "KEGG_CountsRelativeAbundance_TestData.txt")
