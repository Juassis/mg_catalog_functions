...
summary_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/00_Albert_Results/Results/zero_count_summary.txt", header = TRUE, sep = "\t")
...
sample_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/sample.tsv", header = TRUE, sep = "\t")
...
input_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/01_Merged_FunctionalCatalog_Normalized"
output_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2"
...
file_paths <- c(
  "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/TEST/File_1.tsv",
  "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/TEST/File_2.tsv"
)
...
output_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/TEST/merged_data_test.tsv"
...
file_paths <- list.files(
  path = "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2",
...
output_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/Merged_Stats_Functional_Filtered.tsv"
...
input_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/Merged_Stats_Functional_Filtered.tsv"
output_file_relative_abundance <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/Relative_Abundance.tsv"
output_file_tpm <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog2/TPM.tsv"
...
# Directory containing your files
input_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/01_Merged_FunctionalCatalog_Normalized"
output_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Filtered_FunctionalCatalog"
...
```{r}
library(readxl)
meta_filename <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Metadata.xlsx"
...
# Read the data
depth_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/01_Merged_FunctionalCatalog_Normalized/Depth_M01.tsv", header = TRUE, sep = "\t")
...
file_path <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/01_Merged_FunctionalCatalog_Normalized/Depth_Column/"
...
# Read KEGG data
kegg <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/SmallTest/KEGG", sep = "\t", stringsAsFactors = FALSE)
colnames(kegg) <- c("gene", "KEGG_Module1", "KEGG_Module2")

# Read Counts data
counts <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/SmallTest/Counts", sep = "\t", stringsAsFactors = FALSE)
...
write.table(final_output, "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/SmallTest/KEGG_Count_Output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
