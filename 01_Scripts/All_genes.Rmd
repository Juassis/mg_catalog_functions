...
input_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction"
output_dir <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads"
...
for (i in 1:30) {
  ...
  if (i == 1) {  # Plot for the first file as an example
    ...
    ggplot(plot_data, aes(x = rname, y = Value, fill = Metric)) +
      ...
      labs(title = paste("Gene Counts per rname: Filtered by numreads >= 2 (", file_id, ")", sep = ""), 
           x = "rname", y = "numreads") +
...
file_paths <- list.files(
  path = "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads",
...
output_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads/Merged_AllGenes_Reads2.tsv"
...
input_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads/Merged/Merged_AllGenes_Reads2.tsv"
output_file_relative_abundance <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads/Merged/Relative_Abundance.tsv"
output_file_tpm <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/Filtered_2reads/Merged/TPM.tsv"
...
# Read your data
abundance_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/01_KEGG_Modules", header = TRUE, sep = "\t")
module_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/File_D.tsv", header = TRUE, sep = "\t")
...
kegg_modules <- read_tsv(
  "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/TESTE2/01_Functions_AllGenes.tsv",
  col_names = FALSE,
...
Total_Abundance <- read_tsv(
  "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/TESTE2/02_Counts_AllGenes_PerSample.tsv",
  col_names = FALSE,
  show_col_types = FALSE
) %>%
  filter(X1 %in% kegg_modules$X1)
...
Relative_Abundance <- read_tsv(
  "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/TESTE2/03_RelativeAbundance_AllGenes_PerSample.tsv",
  col_names = FALSE,
  show_col_types = FALSE
) %>%
  filter(X1 %in% kegg_modules$X1)
...
# Optionally write to a file
write.table(final_output, "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/KEGG_Counts_Output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
# Read KEGG data
kegg <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/01_KEGG_Moduless", 
                   sep = "\t", 
                   row.names = NULL, 
...
# Optionally write to a file
write.table(final_output, "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/2KEGG_Counts_Output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
kegg <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/ko_output.txt", 
                   sep = "\t", 
                   row.names = NULL, 
                   stringsAsFactors = FALSE)
colnames(kegg) <- c("gene", "KEGG_Module1", "KEGG_Module2")
...
# Read Counts data
counts <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/ko_relativeAbundance.tsv", sep = "\t", stringsAsFactors = FALSE)
colnames(counts)[1] <- "gene"  # Ensure the first column is named 'gene'
...
# Optionally write to a file
write.table(final_output, "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/KEGG_Counts_Output_pathway.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
# Read KEGG data
kegg <- read.delim("/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/01_KEGG_Modules", 
                   sep = "\t", 
                   row.names = NULL, 
                   stringsAsFactors = FALSE)
colnames(kegg) <- c("gene", "KEGG_Module1", "KEGG_Module2")
...
# Reshape the counts data from wide to long format
counts_long <- counts %>%
  pivot_longer(
    cols = starts_with("M"),
    names_to = "Sample",
...
# Join KEGG and counts data with many-to-many relationship allowed
kegg_counts <- kegg %>%
  left_join(counts_long, by = "gene", relationship = "many-to-many")

# Summarize the counts by KEGG module and sample
result <- kegg_counts %>%
  group_by(KEGG_Module, Sample) %>%
  summarize(Count = sum(Count, na.rm = TRUE), .groups = "drop")

# Pivot the data back to wide format for easier viewing
result_wide <- result %>%
  pivot_wider(
    names_from = Sample,
    values_from = Count,
...
write.table(result_wide, "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/Share_Results_AllGenes/New/01_KEGG_Counts_Output2", sep = "\t", row.names = FALSE, quote = FALSE)
...
# Calculate total reads across all samples for each gene (sum across columns for each gene)
total_reads_across_all_samples <- rowSums(count_data, na.rm = TRUE)
...
##### Jan 16, some coverage calculation #######

```{r}
# Read the input file
data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/Organize_All_Files/Merged_AllGenes_Reads2.tsv", header = TRUE, sep = "\t")

# Initialize vectors to store sums and counts
sums <- numeric(ncol(data) - 2)
counts <- numeric(ncol(data) - 2)

# Calculate column-wise sums and counts (excluding NA)
...
# Calculate the total sum and count for all columns combined
total_sum <- sum(sums)
total_count <- sum(counts)
total_average <- total_sum / total_count

# Add a row for the total values
output <- rbind(output, data.frame(Column = "Total", TotalReads = total_sum, Count = total_count, Average = total_average))

# Write the output to a file
write.table(output, "/Users/jasge/Documents/01_Gene_Catalog/Organize_All_Files/coverage_stats.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
...
# Calculate the total sum, count, average, and percentage for all columns combined
total_sum <- sum(sums)
total_count <- sum(counts)
total_average <- total_sum / total_count
...
# Add a row for the total values
output <- rbind(output, data.frame(Column = "Total", TotalReads = total_sum, TotalGenes = total_count, Average = total_average, 'Percentage Genes Mapped' = total_percentage))

# Write the output to a file
write.table(output, "/Users/jasge/Documents/01_Gene_Catalog/Organize_All_Files/coverage_stats_percentage.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
...
save <- output
write.table(output, "/Users/jasge/Documents/01_Gene_Catalog/Organize_All_Files/coverage_stats_percentageMean.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
...
kegg_data <- read.table("/Users/jasge/Documents/01_Gene_Catalog/Organize_All_Files/kegg_module_percentages.txt", 
                        header = TRUE, sep = "\t")
...
# Define file paths
file_paths <- list.files(
  path = "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/TotalReads",
...
# Write the final merged data
output_file <- "/Users/jasge/Documents/01_Gene_Catalog/R_analysis/All_Genes_NoANwithFunction/TotalReads/Merged_AllGenes_ReadsTotal.tsv"
fwrite(merged_dt, file = output_file, sep = "\t", quote = FALSE)
